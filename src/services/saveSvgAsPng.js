//from https://github.com/exupero/saveSvgAsPng/blob/gh-pages/saveSvgAsPng.js !!
   ...
   function prepareSvg(el, options, cb) {
        requireDomNode(el);
    ...
    function svgAsDataUri(el, options, cb) {
        prepareSvg(el, options, function(svg) {
  ...
  function svgAsPngUri(el, options, cb) {
        requireDomNode(el);
        ...
        if(options.canvg) {
             prepareSvg(el, options, convertToPng);
        } else {
